...
#include <malloc.h>
#include <string>
YAML::Node ServerConfig2 = YAML::LoadFile(".\\Config\\config.yml")["Server"];
extern "C"
{
#include "oicq/tea.h"
}
...
public:
	...
	void testSend(ClientNode *Client)
	{
		...
		std::string keys = ServerConfig2["Key"].as<std::string>();
		memcpy(pMsgHead, keys.data(), 16); // QQKey
		pMsgHead += 16;
